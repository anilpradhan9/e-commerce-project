        ...
        cartItem.length > 0 ? <div>
          ...
          <div>
            <div className='mt-10'>
              {
                cartItem.map((item, index) => {
                  return <div key={index} className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3 w-full'>
                    ...
                    <div className='bg-red-500 text-white flex gap-4 p-2 rounded-md text-xl '>
                      <button onClick={() => updateQuantity(cartItem, item.id, "decrement")} className='cursor-pointer'>-</button>
                      <span>{item.quantity}</span>
                      <button onClick={() => updateQuantity(cartItem, item.id, "increment")} className='cursor-pointer'>+</button>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-20'>
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                ...
                <div className='w-full gap-5 flex'>
                  ...
                  <div className='flex flex-col space-y-1 w-full'>
                    ...
                    <input type="text" placeholder='Enter Your PhoneNumber' className='p-2 rounded-md w-full' />
                  </div>
                </div>
                <button className='bg-red-500 text-white px-3 py-3 rounded-md mt-3 cursor-pointer '>Sumbit</button>
              ...
              <div className='bg-gray-100 border-gray-100 shadow-xl rounded-md p-7 h-max mt-4 space-y-2'>
                <h1 className='text-gray-800 font-bold text-xl'>Bill Deatails</h1>
                ...
                <div className='flex justify-between items-center'>
                  ...
                  <p className='text-red-500 font-semibold'><span className='text-gray-700 line-through'>$25 </span> Free </p>
                </div>
                <div className='flex justify-between items-center'>
                ...
                <button className='bg-red-500 px-3 text-white py-2 mt-3  rounded-md cursor-pointer w-full'>Procces to Checkout</button>
              </div>

              <div className='flex justify-between items-center  '>
                <button className='bg-red-500 text-white py-2 '></button>
              </div>
            </div>
          </div>
        </div> : <div className="flex flex-col gap-3 justify-center items-center">
  <h1 className="text-red-500/ font-bold text-5xl text-gray-500">
    Oh no! Your Cart is Empty
  </h1>
  <img src={emptyCart} className="w-[500px] h-[500px] mx-auto" alt="Empty cart" />
  <button
